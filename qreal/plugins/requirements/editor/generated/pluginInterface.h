...
class RequirementsMetamodelPlugin : public QObject, public qReal::EditorInterface
{
	Q_OBJECT
	Q_INTERFACES(qReal::EditorInterface)
	Q_PLUGIN_METADATA(IID "RequirementsMetamodel")

public:

	RequirementsMetamodelPlugin();

	QString id() const { return "RequirementsMetamodel"; }
