...
class RefactoringEditorPlugin : public QObject, public qReal::EditorInterface
{
	Q_OBJECT
	Q_INTERFACES(qReal::EditorInterface)
	Q_PLUGIN_METADATA(IID "RefactoringEditor")

public:

	RefactoringEditorPlugin();

	QString id() const { return "RefactoringEditor"; }
