...
#include "ports.h"
	...
	class ActionElement : public qReal::ElementImpl
	{
	public:
...
;
	...
	class BlockDiagramNode : public qReal::ElementImpl
	{
	public:
		void init(qReal::LabelFactoryInterface &, QList<qReal::LabelInterface*> &) {}
...
;
	...
	class BlockFinalNode : public qReal::ElementImpl
	{
	public:
		void init(qReal::LabelFactoryInterface &, QList<qReal::LabelInterface*> &) {}
...
;
	...
	class ConditionControlFlow : public qReal::ElementImpl {
	public:
	...
	class ConditionNode : public qReal::ElementImpl
	{
	public:
		void init(qReal::LabelFactoryInterface &, QList<qReal::LabelInterface*> &) {}
							...
							, qReal::SdfRendererInterface *renderer, qReal::ElementRepoInterface *elementRepo)
		{
			...
			contents.setHeight(60);
			ports << portFactory.createPort(QPointF(0.0166667, 0.5), false, false, 60, 60, new NonTyped());
			ports << portFactory.createPort(QPointF(0.5, 0.983333), false, false, 60, 60, new NonTyped());
			ports << portFactory.createPort(QPointF(0.983333, 0.5), false, false, 60, 60, new NonTyped());
			ports << portFactory.createPort(QPointF(0.5, 0.0166667), false, false, 60, 60, new NonTyped());
			title_1 = factory.createLabel(1, 0, 0, "condition", false, 0);
			title_1->setBackground(Qt::transparent);
			title_1->setScaling(false, false);
			title_1->setHard(false);
			title_1->setTextInteractionFlags(Qt::NoTextInteraction);
