...
void DragonDiagramMetamodelPlugin::initShallPaletteBeSortedMap()
{
	mShallPaletteBeSortedMap[QString::fromUtf8("DragonDiagram")] = true;
}
...
bool DragonDiagramMetamodelPlugin::shallPaletteBeSorted(QString const &diagram) const
{
...
{
	return QString::fromUtf8(" <groups>\n  <group inNode=\"start\" name=\"atom1\" outNode=\"end\">\n   <groupNode name=\"start\" xPosition=\"0\" yPosition=\"0\" type=\"DragonActionNode\"/>\n   <groupNode name=\"end\" xPosition=\"0\" yPosition=\"100\" type=\"DragonActionNode\"/>\n   <groupEdge type=\"DragonFlow\" to=\"end\" from=\"start\"/>\n  </group>\n  <group inNode=\"all\" name=\"atom2\" outNode=\"all\">\n   <groupNode name=\"all\" xPosition=\"0\" yPosition=\"0\" type=\"DragonActionNode\"/>\n  </group>\n </groups>\n");
}
